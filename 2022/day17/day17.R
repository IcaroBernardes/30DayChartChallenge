...
rawdata <- readxl::read_xlsx("2022/day17/data.xlsx", sheet = "Data")
br_regions <- readxl::read_xlsx("2022/day17/data.xlsx", sheet = "Brazil")
af_regions <- readxl::read_xlsx("2022/day17/data.xlsx", sheet = "Africa")
...
## Saves the plot
ggsave("2022/day17/day17.png", plot = p, dpi = "retina",
       width = 22, height = 28)
